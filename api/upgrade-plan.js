...
module.exports = async (req, res) => {
  ...
  const { customerId, currentSubscriptionId, setupIntentId, currency } = req.body;
  ...
  try {
    ...
    // If no default payment method, get from SetupIntent
    if (!paymentMethod) {
      if (!setupIntentId) {
    ...
    // Determine yearly price for currency
